...
void Block::create_block_mesh(const Texture& texture)
{
    switch (m_block_type)
    {
        case GRASS_BLOCK:
            vertices = {
                // Передняя грань (Z = -0.5) - бок травы
                ...
                // Верхняя грань (Y = 0.5) - верх травы
